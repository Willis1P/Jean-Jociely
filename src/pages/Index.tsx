...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-10 invitation-container">
      <div className="max-w-4xl w-full mx-auto px-4 md:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-10 border border-wedding-medium-green/30">
          <MonogramHeader />
          <InvitationMessage />
          <ParentsNames />
